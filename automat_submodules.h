...
#define ATMT_SUBMODULE_UTILITIES_KINEMATIC_PREDICTOR_ // Enables/Disables KinematicPredictor
    ...
    // Server Platform
        ...
        // #define ATMT_SUBMODULE_SERVER_ARDUINO_WIFI_
        #define ATMT_SUBMODULE_SERVER_ARDUINO_ASYNC_WIFI_ // (Requires esphome/ESPAsyncWebServer-esphome, esphome/AsyncTCP-esphome)
    #else
        #define ATMT_SUBMODULE_SERVER_ESP32_HTTPD_
    #endif

    #if defined(ATMT_SUBMODULE_SERVER_ARDUINO_WIFI_) + defined(ATMT_SUBMODULE_SERVER_ARDUINO_ASYNC_WIFI_) + defined(ATMT_SUBMODULE_SERVER_ESP32_HTTPD_) != 1
